...
class HomePage(BasePage):
    ...
    _feature_section = (By.CSS_SELECTOR, "h4 a")
    ...
    def num_of_el_in_feature_section(self):
        return self.find_elements(locator=self._feature_section)

    def add_item_in_cart(self):
        return self.find_element(locator=self._add_item_to_cart).click()

    def check_is_item_in_cart(self):
        _cart_total = self.find_element(locator=self._cart_total)
        return self.driver.execute_script("return arguments[0].textContent;", _cart_total).strip()

    def click_add_to_wish_list(self):
        return self.click(locator=self._add_to_wishlist)
    ...
    def click_button_search(self):
        return self.click(locator=self._search_button)
